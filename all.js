...
let time_aspect_ratio_app = time_all * currentSpeed * 0.8;

let timeTransformClosing =
  (parseFloat(localStorage.getItem("timeTransformClosing")) || 0.3) *
  currentSpeed;

let cubicTransformClosing = `cubic-bezier(.25,.1,${
  parseFloat(localStorage.getItem("easingScaleClosing")) || 0.2
},${1 + (parseFloat(localStorage.getItem("dampingTransformClosing")) || 0)})`;

let timeScaleClosing =
  (parseFloat(localStorage.getItem("timeScaleClosing")) || 0.4) * currentSpeed;
